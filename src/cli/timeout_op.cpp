...
void handle_connect(const boost::system::error_code &e, single_sync_wait *syncer, bool *out_timeout, boost::system::error_code *out_ec) {
    *out_timeout = false;
...
void handle_trans_with_timeout_ex(const boost::system::error_code &e, size_t bytes_trans, single_sync_wait *syncer, size_t *out_bytes,
                                  bool *out_timeout, boost::system::error_code *out_ec) {
